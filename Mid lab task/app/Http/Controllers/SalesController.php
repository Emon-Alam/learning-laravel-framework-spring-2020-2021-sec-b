...
use App\Http\Requests\Sell_req;
use App\Http\Requests\Excel_req;
use App\Exports\Physical_ES;
use App\Exports\Physical_EP;
...
class SalesController extends Controller
{
    ...
    public function physicalverify(Sell_req $request)
    {
    ...
    public function physicalLogsStore(Excel_req $request)
    {
    ...
    {
        return Excel::download(new Physical_ES, 'MonthlyReportSold.xlsx');
        
    }
    public function physicalLogsPending(Request $request)
    {
        return Excel::download(new Physical_EP, 'MonthlyReportPending.xlsx');
